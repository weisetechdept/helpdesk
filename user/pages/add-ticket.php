                    ...
                    <div class="row" id="app">
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="card">
                                <div class="card-body">
                                    <div class="warning">
                                        หากเป็นเหตุที่ส่งผลให้เกิดผลกระทบร้ายแรง หรือต้องแก้ใขเร่งด่วน กรุณาแจ้งทางโทรศัพท์ และเปิดงานในระบบแจ้งภายหลังได้

                                        <ul class="mt-2 mb-1" v-if="display.branch == 'สำนักงานใหญ่'">
                                            <li>เบอร์ภายใน 507</li>
                                            <li>089 761 0725 (คุณสมเกียรติ)</li>
                                        </ul>

                                        <ul class="mt-2 mb-1" v-if="display.branch == 'ตลาดไท'">
                                            <li>เบอร์ภายใน 331</li>
                                            <li>085 484 3411 (คุณนุช)</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col form-group mt-2">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="file-upload" id="uploadfiles" ref="uploadfiles" name="file_upload">
                                        </div>
                                    </div>
                                </div>
